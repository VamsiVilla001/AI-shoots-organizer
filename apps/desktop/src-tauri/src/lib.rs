...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::rename_tag,
            commands::delete_tag,
            commands::delete_tag_value,
            commands::asset_tags,
            commands::assets_tags,
            commands::assign_tag,
            commands::assign_tag_to_many,
            ...
            commands::smart_nodes,
            commands::media_with_tags,
            commands::tags_in_group,
            commands::suggest_tag_values,
            commands::preview_taxonomy_text,
            commands::import_taxonomy_text,
            commands::export_taxonomy,
            commands::app_info,
