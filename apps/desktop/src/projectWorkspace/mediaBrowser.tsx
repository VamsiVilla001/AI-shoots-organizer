...
export function MediaBrowser({ shootId, groupId, personId, onCollect }: { shootId?: number; groupId?: number; personId?: number; onCollect?: (media: Media[]) => void }) {
  ...
  const media = useQuery({ queryKey: ['media', shootId ?? null, 'workspace', groupId, query, type, person, offset, quality, rating, sort], queryFn: () => api.listMedia({
    ...
    onlyBestShots: quality === 'best', onlyDuplicates: quality === 'duplicates', minRating: rating || null, sort,
