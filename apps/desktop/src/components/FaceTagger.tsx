/**
 * Naming one face by clicking it, then gathering that person's known media.
 *
 ...
 * the viewer opens this next to it. The face's cluster is assigned to that
 * player, albums catch up, and their media is gathered into a named group.
 */
...
export function FaceTagger(props: {
  ...
  /** Names the face's person and gathers every known appearance into a group. */
    ...
    >
      ...
      <div className="face-tagger-actions">
        <button
          ...
          title="Name this person and gather every known appearance into their group"
          onClick={() => tag.mutate()}
        >
